var app_langs = [

    {
        ...
        locales: {
            ...
            lang_Warning: 'Предупреждение',
            lang_ServerWarning: 'Сервер не доступен.',
            lang_CheckOptions: 'Может быть проверить настройки?',
            lang_Loading: 'Загрузка',
            lang_ExtensionOptions: 'Настройки расширения',
            lang_AuthorLink: 'Все пожелания и ошибки можно оставить на странице проекта: ',
            ...
            lang_OopsNoNewsAvailble: 'Нет новостей...',
            lang_By: '',
            lang_On: '',

            //New issue

            lang_SuccesIssueCreated: 'Ваша задача успешно создана',
            ...
            lang_Cancel: 'Отмена',
            lang_NewIssueHint: 'Поля "Трекер" и "Ответственный" появятся после выбора проекта',
            ...
            lang_OopsNoIssuesAvailable: 'Нет задач...',
        ...
        locales: {
            ...
            lang_ServerWarning: 'Server is not accessible.',
            lang_CheckOptions: 'May be update options ?',
            lang_Loading: 'Loading',
            lang_ExtensionOptions: 'Extention Options',
            lang_AuthorLink: 'All features and issues could be sent here: ',
            ...
            //New issue
            lang_SuccesIssueCreated: 'Your issue successfully created !',
            ...
            lang_Cancel: 'Cancel',
            lang_NewIssueHint: '"Tracker" and "Assignee" fields will appear after project selection.',
            ...
            lang_OopsNoIssuesAvailable: 'No issues are available.',
